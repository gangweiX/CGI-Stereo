...
class FlowAugmentor:
    def __init__(self, crop_size=[256, 512], min_scale=-0.2, max_scale=0.5, do_flip=True, yjitter=False, saturation_range=[0,1.4], gamma=[1,1,1,1]):
...
class SparseFlowAugmentor:
    def __init__(self, crop_size, min_scale=-0.2, max_scale=0.5, do_flip=False, yjitter=False, saturation_range=[0,1.4], gamma=[1,1,1,1]):
        # spatial augmentation params
        self.crop_size = crop_size
        self.min_scale = min_scale
        self.max_scale = max_scale
